...
//#define MJRefreshHeaderIdleText  MutableLanguages(@"下拉可以刷新")
//#define MJRefreshHeaderPullingText MutableLanguages(@"松开立即刷新")
//#define MJRefreshHeaderRefreshingText = MutableLanguages(@"正在刷新数据中...")
