...
//    AMapPlaceSearchRequest *request = [[AMapPOIIDSearchRequest alloc] init];
//    
...
/* POI 搜索回调. */
- (void)onPlaceSearchDone:(AMapPOIKeywordsSearchRequest *)request response:(AMapPOISearchResponse *)respons
{
